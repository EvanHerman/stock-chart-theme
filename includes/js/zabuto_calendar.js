...
jQuery.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = jQuery('<span><span class="fa fa-chevron-left text-transparent"></span></span>');
            var $nextMonthNavIcon = jQuery('<span><span class="fa fa-chevron-right text-transparent"></span></span>');
